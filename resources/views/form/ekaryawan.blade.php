...
@section('konten')
	<div class="col-md-9">
      <div class="box box-primary">
        ...
        <div class="box-body">
          {{ Form::model($karyawan,array('method' => 'PUT', 'url' => 'daftarkaryawan/'.$karyawan->idKaryawan.'/edit', 'class' => 'form', 'files' => true)) }}
              <div class="box-body">
                @if($errors->any())
				...
				@endif
					...
					{{ Form::text('namaKaryawan',null,array('placeholder' => 'Masukkan nama', 'class' => 'form-control')) }}
				...
				@endif
					...
					{{ Form::text('tlpKaryawan',null,array('placeholder' => 'Masukkan telepon', 'class' => 'form-control')) }}
				...
				@endif
					...
					{{ Form::text('email',null,array('placeholder' => 'Masukkan Username', 'class' => 'form-control')) }}
					@if ($errors->has('email'))
				...
				@endif
					...
					{{ Form::select('idJabatan',$jab,null,['class'=>'form-control']) }}
				...
				@endif
					...
					{{ Form::select('status',array('Y' => 'Aktif','N' => 'Tidak Aktif'),null,['class'=>'form-control']) }}
				...
				@endif
					...
					{{ Form::select('android',array('Y' => 'Aktif','T' => 'Tidak Aktif'),null,['class'=>'form-control']) }}
				...
				@endif
					...
					{{ Form::select('web',array('Y' => 'Aktif','T' => 'Tidak Aktif'),null,['class'=>'form-control']) }}
					@if ($errors->has('web'))
				...
				@endif
					...
					{{ Form::text('alamatKaryawan',null,array('placeholder' => 'Masukkan Alamat', 'class' => 'form-control')) }}

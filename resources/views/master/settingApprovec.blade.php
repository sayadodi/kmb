...
<div class="row">
        ...
        <div class="box-body">
          <div class="form-group">
            ...
            <div class="row">
              <div class="col-md-12">
                <br>
                <button type="button" class="btn btn-primary btn-savesetc">Submit</button>
                <button type="button" class="btn btn-danger btn-savesetca">Darurat</button>
              </div>
            </div>
            <br>
    ...
    <div class="col-md-6">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Setting Approver SIMIP</h3>
        ...
        <div class="box-body">
          ...
          @else
            <a href="{{url('alihkanb/'.$sekarang->idSetting)}}" class="btn btn-danger btn-xs">Aktifkan</a>
          @endif
        </div>
        <!-- /.box-body -->
      </div>
    ...
    <div class="col-md-6">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
        <h3 class="box-title">Setting Approver SIMIP Darurat</h3>
        ...
        <div class="box-body">
          ...
          @if ($sekaranga->status == "Y")
            <span class="label label-success">Sedang Aktif</span>
          @else
            <a href="{{url('alihkanb/'.$sekaranga->idSetting)}}" class="btn btn-danger btn-xs">Aktifkan</a>
          @endif
        </div>
        <!-- /.box-body -->
      </div>

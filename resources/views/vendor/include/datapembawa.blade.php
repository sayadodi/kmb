    ...
    <div class="col-md-12">
        <form method="post" action="" enctype="multipart/form-data" class="form-horizontal" id="formpembawa">
            ...
            <div class="form-group hidden historinya">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <select name="idpembawa" id="" class="form-control select2 caritamu" style="width: 100%;">
...
<script>
    $(document).ready(function(){
        ...
        var url = url_local+"/kmb/public/carihistoritamu/";
        var urlsp = url_local+"/kmb/public/daftarkeluar/simpanpembawa";

...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 28 Jan 2021 pada 04.34
...
-- Fungsi
--
CREATE DEFINER=`root`@`localhost` FUNCTION `cariurutan` (`idapprove` INT, `idpengaturan` INT) RETURNS INT(11) BEGIN
...
--
-- Stand-in struktur untuk tampilan `daftarpengiriman`
-- (Lihat di bawah untuk tampilan aktual)
--
CREATE TABLE `daftarpengiriman` (
`idapprove` int(5)
,`kodekirim` int(7)
,`kodevendor` smallint(5)
...
,`tglkeluar` datetime
,`nopo` varchar(10)
,`statuskiriman` enum('Mengatur','Meminta Gudang','Diterima Gudang','Ditolak Gudang','Diterima Pos','Proses Approve','Selesai')
,`idpengaturan` tinyint(2)
,`tujuan` varchar(50)
,`berkas` varchar(100)
,`status` enum('PO','NonPO')
,`pos` smallint(3)
,`loby` smallint(3)
,`gudang` smallint(3)
,`areakhusus` enum('Y','N')
,`namavendor` varchar(100)
,`kdvendor` smallint(5)
);
...
(6, '2021-01-27 17:44:27', 'Barang', NULL, 11, NULL, NULL, 'Proses');
...
(18, 'nnqmis', 'Masker Medis 3 Ply', 400, 'box', 'PO', 'Standar BNPB isi 50/Box warna Hijau, Ear Loop', 11, 1, 'Baru', NULL, 'Gambar20210127135212.jpg', 'Berkas20210127135212.jpg');
...
--
-- Dumping data untuk tabel `tbdetailtamu`
--

INSERT INTO `tbdetailtamu` (`iddetailtamu`, `namatamu`, `pengenal`, `nopengenal`, `jabatan`, `notlptamu`, `alamattamu`, `fototamu`) VALUES
(12, 'Rapli', 'KTP', '90922665', 'Pengirim', '0876353431', 'Paiton', ''),
(13, 'Rapli skuy', 'SIM', '9092266577', 'Pengiriman', '0876353431', 'Paiton mkh', '');
...
--
-- Struktur dari tabel `tbhistorikendaraan`
--

CREATE TABLE `tbhistorikendaraan` (
  `idhistorikend` int(6) NOT NULL,
...
--
-- Dumping data untuk tabel `tbhistorikendaraan`
--

INSERT INTO `tbhistorikendaraan` (`idhistorikend`, `idtamu`, `jenis`, `tglmasuk`, `idkendaraan`, `nogate`, `kdvendor`) VALUES
(1, 11, 'Pengiriman', '2021-01-27 17:29:51', 11, NULL, 11);

-- --------------------------------------------------------

--
-- Struktur dari tabel `tbhistoritamu`
--

CREATE TABLE `tbhistoritamu` (
  `idhistori` int(6) NOT NULL,
...
--
-- Dumping data untuk tabel `tbhistoritamu`
--

INSERT INTO `tbhistoritamu` (`idhistori`, `iddetailtamu`, `idtamu`, `jenis`, `tgltamu`, `nopass`, `nopassa`, `kdvendor`) VALUES
(1, 12, 11, 'Pengiriman', '2021-01-27 14:02:53', NULL, NULL, 11),
(2, 13, 11, 'Pengiriman', '2021-01-27 14:57:16', NULL, NULL, 11);
...
--
-- Dumping data untuk tabel `tbhistorivendor`
--
...
(29, 11, NULL, '2021-01-27 17:35:06', 'Meminta kiriman', 'Meminta', 'Minta Kirim', 11),
(30, 11, 1, '2021-01-27 17:44:27', 'Kirim Silahkan', 'Terima', 'Minta Kirim', 11);
...
(11, 'Pick up', 'Dino Dutro', 'N 858 LN');
...
(11, 11, 'Pengadaan Masker 3 PLy', '2021-01-27 13:47:26', '2021-01-28', NULL, NULL, 'OK1091', 'Diterima Gudang', 3, 'Gudang', '20210127150012.jpg', 'PO', NULL, NULL, NULL, NULL);
...
CREATE TABLE `tbsimip` (
  ...
  `jeniskendaraan` enum('Y','N') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Indeks untuk tabel `tbhistorikendaraan`
--
ALTER TABLE `tbhistorikendaraan`
  ADD PRIMARY KEY (`idhistorikend`);

--
-- Indeks untuk tabel `tbhistoritamu`
--
ALTER TABLE `tbhistoritamu`
...
--
ALTER TABLE `tbapprove`
  MODIFY `idapprove` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT untuk tabel `tbdetailapprove`
--
ALTER TABLE `tbdetailapprove`
  MODIFY `iddetailapprove` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `tbdetailpengiriman`
  MODIFY `iddetailkirim` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT untuk tabel `tbdetailtamu`
--
ALTER TABLE `tbdetailtamu`
  MODIFY `iddetailtamu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
-- AUTO_INCREMENT untuk tabel `tbhistorikendaraan`
--
ALTER TABLE `tbhistorikendaraan`
  MODIFY `idhistorikend` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT untuk tabel `tbhistoritamu`
--
ALTER TABLE `tbhistoritamu`
  MODIFY `idhistori` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT untuk tabel `tbhistorivendor`
--
ALTER TABLE `tbhistorivendor`
  MODIFY `idhistoriv` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
-- AUTO_INCREMENT untuk tabel `tbkendaraan`
--
ALTER TABLE `tbkendaraan`
  MODIFY `idkendaraan` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `tbpengiriman`
  MODIFY `kodekirim` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT untuk tabel `tbsimip`
--
ALTER TABLE `tbsimip`
...
--
ALTER TABLE `tbvendor`
  MODIFY `kdvendor` smallint(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
COMMIT;
